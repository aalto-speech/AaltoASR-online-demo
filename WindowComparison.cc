...
WindowComparison::WindowComparison(PG_Widget *parent,
  ...
  : WindowChild(parent, "Comparison results", 300, 500, true, "OK"),
...
{
  fprintf(stderr, "WC constructing array\n");
  ...
  this->construct_label(0, 1, "Correct", PG_Label::RIGHT);
  this->construct_label(0, 2, "Substitution", PG_Label::RIGHT);
  this->construct_label(0, 3, "Deletion", PG_Label::RIGHT);
  this->construct_label(0, 4, "Insertion", PG_Label::RIGHT);

  this->construct_label(0, 6, "CHARACTER", PG_Label::RIGHT);
  this->construct_label(1, 6, "N", PG_Label::CENTER);
  this->construct_label(2, 6, "%", PG_Label::CENTER);
  this->construct_label(0, 7, "Correct", PG_Label::RIGHT);
  this->construct_label(0, 8, "Substitution", PG_Label::RIGHT);
  this->construct_label(0, 9, "Deletion", PG_Label::RIGHT);
  this->construct_label(0, 10, "Insertion", PG_Label::RIGHT);

  this->construct_numeric_label(1, 1, result._word.correct);
  this->construct_numeric_label(1, 2, result._word.substitution);
  this->construct_numeric_label(1, 3, result._word.deletion);
  this->construct_numeric_label(1, 4, result._word.insertion);

  this->construct_numeric_label(1, 7, result._char.correct);
  this->construct_numeric_label(1, 8, result._char.substitution);
  this->construct_numeric_label(1, 9, result._char.deletion);
  this->construct_numeric_label(1, 10, result._char.insertion);

  unsigned int total = result._word.correct + result._word.substitution +
                       result._word.deletion + result._word.insertion;
  this->construct_percentage_label(2, 1, result._word.correct, total);
  this->construct_percentage_label(2, 2, result._word.substitution, total);
  this->construct_percentage_label(2, 3, result._word.deletion, total);
  this->construct_percentage_label(2, 4, result._word.insertion, total);
  
  total = result._char.correct + result._char.substitution +
          result._char.deletion + result._char.insertion;
  this->construct_percentage_label(2, 7, result._char.correct, total);
  this->construct_percentage_label(2, 8, result._char.substitution, total);
  this->construct_percentage_label(2, 9, result._char.deletion, total);
  this->construct_percentage_label(2, 10, result._char.insertion, total);
